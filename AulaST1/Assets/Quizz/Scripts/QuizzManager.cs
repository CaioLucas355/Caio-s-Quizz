...
public class QuizzManager : MonoBehaviour
{
    ...
    public AudioClip musicaMJogo;

    [Header("Arquivos de Efeitos Sonóros")]
    ...
    public void IniciarJogo()
    {
        ...
        caixaDeMusica.clip = musicaMJogo;
        caixaDeMusica.Play();
    }
    ...
    {
        StartCoroutine(ValidarResoposta(numero));
        
    }
    
    //Co rotina para mostrar se acertou ou errou
    IEnumerator ValidarResoposta (int numero) 
    {
